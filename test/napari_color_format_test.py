...
class NapariColorFormatTest(unittest.TestCase):
    def test_to_rgba_array(self):
        ...
        self.assertEqual(
            NapariColorFormat.to_rgba_array(test_case_1), expected_result_1
        )
        self.assertEqual(
            NapariColorFormat.to_rgba_array(test_case_2), expected_result_2
        )
        self.assertEqual(
            NapariColorFormat.to_rgba_array(test_case_3), expected_result_3
        )
